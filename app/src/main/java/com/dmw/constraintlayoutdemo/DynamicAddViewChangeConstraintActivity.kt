...
import kotlinx.android.synthetic.main.activity_dynamic_addview_change_constraint.*

class DynamicAddViewChangeConstraintActivity : AppCompatActivity() {

    companion object {

        fun launch(context: Context) {
            val intent = Intent(context, DynamicAddViewChangeConstraintActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dynamic_addview_change_constraint)
